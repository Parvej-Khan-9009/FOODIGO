...
function TopRestaurant(){
    ...
    if(resData == 'swiggy_not_present' || TopRestaurantData == undefined) {
        ...
        <div className="w-full md:pt-[75px] sm:pt-[50px] pt-[40px]">
            <div className="lg:w-[82%] w-[95%] mx-auto">
                <div className="flex justify-between">
                    <span className="md:text-2xl sm:text-[22px] text-xl font-bold">{title}</span>
                    <div className=" flex gap-3">
                        <div className="hidden md:flex items-center justify-center hover:bg-[#e5e7e7] hover:text-[#898a8a] hover:cursor-pointer w-[37px] h-[37px] bg-[#D7D8D9] rounded-full" onClick={prevSlide}>
                            <FaArrowLeftLong />
                        </div>
                        <div className="hidden md:flex items-center justify-center hover:bg-[#e5e7e7] hover:text-[#898a8a] hover:cursor-pointer w-[37px] h-[37px] bg-[#D7D8D9] rounded-full" onClick={nextSlide}>
                            <FaArrowRight/>
                        </div>
                    </div>
                </div>

                <div className="md:pt-[20px] pt-[14px] flex md:gap-6 sm:gap-4 gap-2 overflow-x-scroll scroll-smooth no-scrollBar" ref={slider} >
                    {
