...
export const swiggyBaseRestaurantOriginApi = 'https://www.swiggy.com/dapi/restaurants/list/v5?lat=';

export const locationDataApi = 'https://www.swiggy.com/dapi/misc/address-recommend?place_id='

export const locationNameApi = 'https://www.swiggy.com/dapi/misc/place-autocomplete?input='

export const searchedRestaurantImage = 'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/'

export const restaurantNameApi = 'https://www.swiggy.com/dapi/restaurants/search/suggest?lat='

export const SearchedRestaurantApi = 'https://www.swiggy.com/dapi/restaurants/search/v3?lat='